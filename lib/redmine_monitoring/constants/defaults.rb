...
module RedmineMonitoring
  module Constants
    DEFAULT_SETTINGS = {
      ...
      recommendations_retention_days: 90,
      security_retention_days: 180,
      mask_sensitive_data: true,
      sensitive_keys: %w[password token authorization cookie secret api_key],
      capture_headers: true,
      capture_env: true,
      params_max_bytes: 65_536,
      headers_max_bytes: 32_768,
      env_max_bytes: 255,
      backtrace_max_bytes: 131_072,
      notify_enabled: true,
